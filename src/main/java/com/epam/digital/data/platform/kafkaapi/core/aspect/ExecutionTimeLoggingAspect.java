...
public class ExecutionTimeLoggingAspect {
  ...
  private static final String KAFKA_REQUEST_OPERATION_NAME = "Kafka request processing";
  ...
  public Object logKafkaRequestProcessingTime(ProceedingJoinPoint joinPoint) throws Throwable {
    return logJoinPointTime(joinPoint, KAFKA_REQUEST_OPERATION_NAME);
  }
