...
@SpringBootTest(classes = GenericDeleteCommandListenerTestImpl.class)
class GenericDeleteCommandListenerTest {
  ...
  @MockBean
  DeleteCommandHandlerTestImpl mockCommandHandler;
  @MockBean
  InputValidationService inputValidationService;
  @MockBean
  ResponseMessageCreator responseMessageCreator;
  @Autowired
  private GenericDeleteCommandListenerTestImpl commandListener;
  ...
  void happyDeletePath() {
    commandListener.delete(KEY, mockRequest());
  ...
  @Test
  @DisplayName("Check if response is valid when DB error for delete")
  void procedureErrorOnDelete() {
    doThrow(new ProcedureErrorException("")).when(mockCommandHandler).delete(any());
  ...
  @Test
  @DisplayName("Check if response is valid when NPE for delete")
  void nullPointerExceptionOnDelete() {
    doThrow(new NullPointerException("")).when(mockCommandHandler).delete(any());
  ...
  void shouldReturnErrorStatusFromValidation() {
    ...
    var actualMessage = commandListener.delete(KEY, mockRequest());
