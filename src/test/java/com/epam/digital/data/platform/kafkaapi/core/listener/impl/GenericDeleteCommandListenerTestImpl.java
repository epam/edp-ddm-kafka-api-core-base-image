...
import com.epam.digital.data.platform.kafkaapi.core.listener.GenericDeleteCommandListener;
...
@TestComponent
public class GenericDeleteCommandListenerTestImpl extends GenericDeleteCommandListener<MockEntity> {

  protected GenericDeleteCommandListenerTestImpl(DeleteCommandHandlerTestImpl commandHandler) {
