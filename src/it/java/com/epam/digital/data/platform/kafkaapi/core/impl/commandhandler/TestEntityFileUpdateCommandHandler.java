...
@Service
public class TestEntityFileUpdateCommandHandler
    extends AbstractUpdateCommandHandler<TestEntityFile> {

  public TestEntityFileUpdateCommandHandler(
      EntityConverter<TestEntityFile> entityConverter,
